...
let
     ...
     # Save
     output_file = "article/png_files/us_vs_global.png"
     ...
     # Save
     output_file = "article/png_files/global_time_split_hydro_lvs.png"
     mkpath(dirname(output_file))
     save(output_file, fig, px_per_unit=px_per_unit)
     ...
     # Save
     output_file = "article/png_files/global_basin_split_hydro_lvs.png"
     mkpath(dirname(output_file))
     save(output_file, fig, px_per_unit=px_per_unit)
     ...
     # Save
     output_file = "article/png_files/lstm_vs_benchmarks.png"
     mkpath(dirname(output_file))
     save(output_file, fig, px_per_unit=px_per_unit)
