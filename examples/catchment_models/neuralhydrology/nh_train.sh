...
#SBATCH --job-name=usa_time_nse_sqrt.yml
...
set -x # echo script
nh-run train --config-file /groups/esm/achiang/Rivers/examples/catchment_models/neuralhydrology/usa_time_nse_sqrt.yml
echo done
