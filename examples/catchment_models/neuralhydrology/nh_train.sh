...
#SBATCH --job-name=usa_time_high_dt-gamma.yml
...
set -x # echo script
nh-run train --config-file /home/achiang/CliMA/Rivers/examples/catchment_models/neuralhydrology/usa_time_high_dt-gamma.yml
echo done
