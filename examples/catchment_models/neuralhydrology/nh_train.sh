...
#SBATCH --job-name=usa_time_nse_sqrt2.yml
...
set -x # echo script
nh-run train --config-file /groups/esm/achiang/Rivers/examples/catchment_models/neuralhydrology/usa_time_nse_sqrt2.yml
echo done
