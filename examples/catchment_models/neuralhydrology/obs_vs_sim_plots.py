...
with open("runs/usa_time_split_2606_124027/test/model_epoch005/test_results.p", "rb") as fp:
    results = pickle.load(fp)

# print(results['7050013170']['1D']['xr'])
...
plt.savefig("runs/usa_time_split_2606_124027/test/obs_vs_sim.png")
